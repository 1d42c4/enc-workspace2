# a89: Threefish-1024-CTR

**Classification: composed / experimental.** Threefish tweak is all zero; the mode is CTR64BE over the full block. This is a custom file construction, not Skein or a standardized Threefish AEAD.
